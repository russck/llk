...
BEGIN_MESSAGE_MAP(CLLKDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_CONFIG, &CLLKDlg::OnBnClickedButtonConfig)
...
void CLLKDlg::OnPaint()
{
	...
	else
	{
		...
		/*//设置背景
		dc.SetTextColor(RGB(255,20,147));
		dc.SetBkColor(RGB(205,201,165));

		CString strWel = _T("Welcome");
		...
		// 获取字符串宽度和高度
		CSize size = dc.GetTextExtent(strWel, strWel.GetLength());
		//绘制
...
void CLLKDlg::OnBnClickedButton7()
{
	// TODO: 在此添加控件通知处理程序代码
}
...
void CLLKDlg::OnBnClickedButtonConfig()
{
	// TODO: 在此添加控件通知处理程序代码
}
